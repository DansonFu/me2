...
public interface GamecustomerMapper {
    /**
     * 根据条件查询记录总数
     */
     ...
     * 根据条件更新属性不为空的记录
     */
    int updateByParamsSelective(@Param("record") Gamecustomer record, @Param("condition") Map<String, Object> condition);

    /**
     * 根据条件更新记录
     */
    int updateByParams(@Param("record") Gamecustomer record, @Param("condition") Map<String, Object> condition);
