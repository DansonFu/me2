...
import com.lettucetech.me2.common.utils.TypeCaseHelper;
...
public class Criteria {
	...
	protected Criteria(Criteria condition) {
		this.vlueList = condition.vlueList;
		this.orderByClause = condition.orderByClause;
		this.condition = condition.condition;
		this.distinct = condition.distinct;
		this.oracleStart = condition.oracleStart;
		this.oracleEnd = condition.oracleEnd;
	}
	...
	public List getVlueList() {
		return vlueList;
	}

	public void setVlueList(List vlueList) {
		this.vlueList = vlueList;
	}
