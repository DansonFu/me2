...
public class CommentUtil {
  private static Logger log = (Logger) LoggerFactory.getLogger(CommentUtil.class);
  // 凭证获取（GET）
   ...
   */
  public static WexinUserInfo getUserInfo(String accessToken, String openId) {
    WexinUserInfo weixinUserInfo = null;
    // 拼接请求地址
    ...
    if (null != jsonObject) {
      try {
        weixinUserInfo = new WexinUserInfo();
        // 用户的标识
