		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<div class="row form-group">
					<div class="col-lg-6">
						<div class="col-lg-3 input-column">头像：</div>
						<div class="col-lg-9">
							<img src="${domain}/${picture.customer.headimgurl}" width="70px"
								height="70px" />
						</div>
					</div>
					<!-- col-lg-6 -->
					<div class="col-lg-6">
						<div class="col-lg-3 input-column">ID：</div>
						<div class="col-lg-9">
				...
				<div class="row form-group">
					<div class="col-lg-6">
						<div class="col-lg-3 input-column">呢称：</div>
						<div class="col-lg-9">${picture.customer.username }</div>
					</div>
					<div class="col-lg-6">
						<div class="col-lg-3 input-column">性别：</div>
						<div class="col-lg-9">
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form class="form-bordered" id="me2form"
					...
					<div class="row form-group">
						<div class="col-lg-6">
							...
							<div class="col-lg-6" style="height: 120px">
								<a href="${domain}/${picture.qiniukey}" target="_blank"
									id="afront"> <img src="${domain}/${picture.qiniukey}"
						...
						<div class="col-lg-6">
							...
							<div class="col-lg-7" id="fileDiv" style="height: 120px">
								<input type="file" name="bfile" /> <a
									href="${picture.bpicture.qiniukey}" target="_blank"
									id="abpicture"> <img src="${picture.bpicture.qiniukey}"
									width="80px" height="80px" id="imgbpicture" />
								</a>
							</div>
							<div class="col-lg-7" id="textDiv"
								style="display: none; height: 120px">
								<input type="text" name="content" style="width: 80%;"
									value="${picture.bpicture.qiniukey}" />
							</div>
						</div>
						<!-- col-lg-6 -->
					...
					<div class="row form-group">
						<div class="col-lg-6">
							<div class="col-lg-3 input-column">位置：</div>
							<div class="col-lg-9">
								<input type="text" name="locationTitle" style="width: 80%;"
									value="${picture.locationTitle}" />
							</div>
						</div>
						<!-- col-lg-6 -->
						<div class="col-lg-6">
							<div class="col-lg-3 input-column">地址：</div>
							<div class="col-lg-9">
								<input type="text" name="locationContent" style="width: 80%;"
									value="${picture.locationContent}" />
							</div>
						</div>
						<!-- col-lg-6 -->
					</div>
					...
					<div class="row form-group">
						...
						<div class="col-lg-6">
							<div class="col-lg-3 input-column">心情：</div>
							<div class="col-lg-9">
								<input type="text" name="mood" style="width: 80%;"
									value="${picture.mood}" />
							</div>
						</div>
						<!-- col-lg-6 -->
								...
								<select name="gameId">
									<c:forEach items="${games}" var="game" varStatus="">
										<option value="${game.gameId }"
											<c:if test="${game.gameId == picture.gameId}">selected="selected"</c:if>>${game.name }</option>
									</c:forEach>
								</select>
							</div>
						</div>
					...
					<div class="row form-group">
						...
						<div class="col-lg-6" id="bfeelDiv">
							<div class="col-lg-3 input-column">B面心情：</div>
							<div class="col-lg-9">
								<input type="text" name="bmood" style="width: 80%;"
									value="${picture.bpicture.mood}" />
							</div>
						</div>
						<!-- col-lg-6 -->
					</div>
			...
			<c:forEach items="${comments }" var="comment">
				...
				<div class="row form-group">
					<div class="col-lg-12">
						...
						<div class="col-lg-6">
							<textarea class="form-control" rows="5" placeholder="评论内容"
								name="commentContent"
						...
						<div class="col-lg-2">
							<c:if test="${comment.qiniukey != null}">
								<img alt="" src="${domain }/${comment.qiniukey }" width="50px"
									height="50px">
								<br>
							</c:if>
						</div>
