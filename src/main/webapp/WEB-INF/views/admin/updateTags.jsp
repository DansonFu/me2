...
<div class="page-content">
	<div class="row">
	<div class="col-xs-12">
		<h3 class="header smaller lighter blue">修改标签</h3>
		...
		<form action="<%=basePath %>admin/viewList" method="post" id="update">
				...
				<tbody>
				 <div class="col-lg-6">
						 ...
						 <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-9">
                                    	<input type="text" name="mefriends"/>
                                    </div>
                                </div>
						 <div>
...
<script type="text/javascript">
	...
	function submitform(){
		...
		if($("input[name='hits']").val()==""){
			$("input[name='hits']").focus();
			return;
		}
		if($("input[name='mefriends']").val()==""){
			$("input[name='mefriends']").focus();
			return;
		}
