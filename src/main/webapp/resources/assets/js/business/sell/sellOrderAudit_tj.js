...
function billSubmit(obj){
	...
	var jsondata =jsondata = {"phone":phone,"note":note,
			"address":address,"mobile":mobile,"needPay":needPay,
			...
			"orderId":orderId,"shipmentEnterprise.seId":seId,
			"priority":$("#priority").val(),
			"taskId":$("#form_taskId").val(),"id":$("#form_id").val(),
			"comment":$("#form_comment").val(),"outcome":obj.value};
	
    $.ajax({
		url:basePath+"erp/sellOrderAuditSubmit_tj",
		type:"post",
		datatype:"json",
