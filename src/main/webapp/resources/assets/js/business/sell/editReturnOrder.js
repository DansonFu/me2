...
function billSubmit(isStartProcess){
	...
	var jsondata = {"isStartProcess":isStartProcess,"orderId":orderId,"amount":amount,"griddata":griddata,"note":note};

    $.ajax({
		url:basePath+"erp/returnOrder/editOrder",
		type:"post",
		datatype:"json",
