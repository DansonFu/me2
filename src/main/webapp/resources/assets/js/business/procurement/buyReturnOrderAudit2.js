...
//		url:basePath+"erp/buyReturnOrder/getOrderMaterialList",//获取数据的地址
//		mtype:"POST",
//		datatype: "json",//从服务器端返回的数据类型
//		height: 'auto',//表格高度
//		rownumbers:true,//显示行号
//		colNames:['ID', '产品', '产品名称','产品编号','规格','色号','单价','件数', '片数', '面积','总金额','优惠金额'],//列显示名称
//		colModel:[
...
//		loadonce:true,
//		postData:{"orderId":requestReturnOrderId},
