...
//	dataobject.orderId = orderId;
	...
	var jsondata =jsondata = {"isStartProcess":isStartProcess,"phone":phone,"note":note,"address":address,"mobile":mobile,"needPay":needPay,"productType":productType,"amount":amount,"griddata":griddata,"name":contactName,"contact.contactId":contactId,"contact.name":contactNameHidden,"orderId":orderId};
	
    $.ajax({
		url:basePath+"erp/buyOrder/editOrder",
		type:"post",
		datatype:"json",
...
//	columns:[[
//		{field:'contactId',title:'客户id',width:50},
//		{field:'name',title:'客户姓名',width:100},
//		{field:'address',title:'客户姓名',address:200},
...
//        },
//        query:function(q){
//        	$('#contactId').combogrid("grid").datagrid("reload", { 'keyword': q });
//        	$('#contactId').combogrid("setValue", q);
//        	return false;
//        }
//   },
//   onSelect:function(){
//       var grid=$("#contactId").combogrid("grid");//获取表格对象
//       var row = grid.datagrid('getSelected');//获取行数据
//       $("#contactId2").val(row.contactId);
//       $("#phone").val(row.phone);
