...
function billSubmit(isStartProcess){
	...
	var jsondata = {"orderPreType":orderPreType,"isStartProcess":isStartProcess,"orderId":orderId,"amount":amount,"griddata":griddata,"shipmentEnterprise.seId":seId,"note":note};
...
function selectOrderOnclick(){
	$.fDialog({
		title : '<b>采购订单列表</b>',
		content : basePath+'erp/selectReturnOrder?type=3',
		module : 'iframe',
		w : '80%',
		h : '522',
