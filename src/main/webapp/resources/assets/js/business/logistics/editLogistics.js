...
function billSubmit(isStartProcess){
	...
	var jsondata  = {"logisticsId":logisticsId,"order.orderId":orderId,"sendTime":sendTime,"carrier":carrier,"shipmentEnterprise.seId":shipmentEnterprisetId,"mobile":mobile,"consignee":consignee,"sender":sender};
	
    $.ajax({
		url:basePath+"erp/logistics/editLogistics",
		type:"post",
		datatype:"json",
		data: jsondata,
