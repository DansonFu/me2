jQuery(function($) {
	...
	jQuery(grid_selector).jqGrid({
		...
		datatype: "json",
		height: "auto",
		colNames:[ '编号', '菜单按钮名称', '菜单按钮编码','菜单按钮描述', '类型', '排序','创建时间'],
		colModel:[
			{name:'mId', key:true, index:'mId', width:80, editable: false, hidden:true,search:false, viewable:true},
			{name:'name',index:'name', width:"20%", editable: true,search:true,stype:'text',searchoptions:{sopt:['cn']},
			...
			{name:'code',index:'code', width:"10%", editable: true,search:true,stype:'text',searchoptions:{sopt:['cn']}},
			{name:'note',index:'description', width:"30%", editable: true,edittype:"textarea", search:false},
			{name:'type',index:'type', width:"5%", editable: true,search:true,edittype:'select',editoptions:{
				value:"1:菜单;2:按钮"
			},formatter:function(val){
				return val==1?"菜单":"按钮";
			}},
			{name:'num',index:'num', width:"5%", editable: true,search:false,stype:'text',searchoptions:{sopt:['cn']}},
			{name:'addTime',index:'addTime', width:"10%", editable:false, searchoptions:{
